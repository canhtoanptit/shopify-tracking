...
import { PaypalComponent } from 'app/entities/paypal/paypal.component';
import { PaypalService } from 'app/entities/paypal/paypal.service';
import { Paypal } from 'app/shared/model/paypal.model';

describe('Component Tests', () => {
  describe('Paypal Management Component', () => {
    let comp: PaypalComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PaypalComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.paypals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
